...
import { noto_sans, poppins } from "../../lib/font";
        ...
        <div>
            ...
            <div className="min-h-screen max-h-screen bg-white text-black flex flex-row items-center overflow-hidden">
                ...
                <div className={`w-1/3 flex flex-row pr-24 gap-10 right-0 items-center justify-center ${noto_sans.className}`}>
                    <div className="p-5 inset-shadow-sm shadow-2xl bg-white rounded-2xl flex flex-col gap-20 min-w-96 justify-center items-center">
                        ...
                        <div className="w-full flex flex-col gap-10">
                            ...
                            <button disabled={wait} onClick={e => handle_login()} className={`cursor-pointer text-white font-bold p-2 text-center rounded-lg w-full text-xl ${wait ? "scale-95 bg-green-300" : "bg-green-700"}`}>
                                Login
                            </button>
                        </div>
                    </div>
