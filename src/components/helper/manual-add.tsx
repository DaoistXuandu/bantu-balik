...
export default function ManualAdd({ id }: { id: string }) {
    ...
    return (
        <button onClick={e => router.push(`./${id}/refund`)} className="cursor-pointer hover:scale-95 w-44 text-black rounded-md overflow-hidden flex items-center border-1 border-dashed border-gray-500" >
